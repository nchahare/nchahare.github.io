...
**Zotero** is an app that scholars around the world use to manage their references. References are useful pieces of information from books, articles, videos, or web pages. When academics write something, they need to support it with evidence. As a scientist myself, when I make a claim or statement, I have to prove it with my own experimental data or “cite” somebody else’s work as a reference. This is called **citation** and **reference**.
...
**Citation example**: Let’s say you are writing an essay and you want to include a quote from a book. You would use a citation to mention the author’s name and the page number where the quote can be found. For example, you might write: “According to Smith (2010), ‘quote goes here’ (p. [25).” This citation gives credit to the original author and provides evidence for your argument](https://apastyle.apa.org/style-grammar-guidelines/references/examples)
...
{% include figure.html path="assets/img/Pasted image 20230926215521.png" title="logo of the club" class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row justify-content-sm-center">
{% include figure.html path="assets/img/Pasted image 20230926215833.png" title="logo of the club" class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row justify-content-sm-center">
{% include figure.html path="assets/img/Pasted image 20230926225608.png" title=" " class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row justify-content-sm-center">
{% include figure.html path="assets/img/Pasted image 20230926230121.png" title=" " class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row justify-content-sm-center">
{% include figure.html path="assets/img/Pasted image 20230927105023.png" title=" " class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row justify-content-sm-center">
{% include figure.html path="assets/img/Pasted image 20230927105320.png" title=" " class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row justify-content-sm-center">
{% include figure.html path="assets/img/Pasted image 20230927105928.png" title=" " class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row justify-content-sm-center">
{% include figure.html path="assets/img/Pasted image 20230927110042.png" title=" " class="img-fluid rounded z-depth-1" %}
</div>


2. Now, Zotero will import all the correct details about the book.
<div class="row justify-content-sm-center">
{% include figure.html path="assets/img/Pasted image 20230927110224.png" title=" " class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="row justify-content-sm-center">
{% include figure.html path="assets/img/Pasted image 20230927112605.png" title=" " class="img-fluid rounded z-depth-1" %}
</div>
