...
<div class="row justify-content-sm-center">
{% include figure.html path="assets/img/fea3.png" alt="fre introduction" caption="von Mises stress distributions corresponding to A) fully pinned, B) Semi pinned, and C) Pivot boundary conditions are shown on the back, midsection, front, and base surfaces of the mandible." %}
</div>
